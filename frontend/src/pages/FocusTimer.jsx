...
export const sharedFocusShell = {
    ...
    sectionCard: {
        ...
        boxShadow: "0 32px 70px -50px rgba(8,47,73,0.7)",
        padding: "1.8rem 2rem",
        display: "grid",
        gap: "1.5rem",
    },
    ...
    heroActionCard: {
        ...
        boxShadow: "0 26px 42px -32px rgba(15,23,42,0.95)",
        alignSelf: "start",
    },
    heroRight: {
        display: "grid",
    ...
    highlightChip: {
        ...
        alignItems: "center",
        gap: "0.5rem",
        boxShadow: "0 12px 26px -28px rgba(15,23,42,1)",
    },
    highlightChipIcon: {
        width: "1rem",
        height: "1rem",
...
const styles = {
    ...
    statCard: {
        ...
        boxShadow: "0 30px 60px -45px rgba(15,23,42,0.8)",
        display: "grid",
        gap: "0.75rem",
    },
    statHeader: {
    ...
    timerConfigurator: {
        ...
        border: "1px solid rgba(148,163,184,0.22)",
        background: "linear-gradient(120deg, rgba(15,23,42,0.78), rgba(30,41,59,0.88))",
        display: "grid",
        gap: "1.2rem",
        boxShadow: "0 36px 72px -48px rgba(8,47,73,0.7)",
    },
    configHeader: {
        display: "grid",
        gap: "0.45rem",
    ...
    configButton: {
        ...
        cursor: "pointer",
        transition: "transform 0.2s ease, box-shadow 0.2s ease",
        boxShadow: "0 16px 32px -24px rgba(56,189,248,0.6)",
    },
    configValue: {
        flex: 1,
        display: "grid",
