...
const Settings = () => {
    ...
    const styles = {
        ...
        container: {
            ...
            padding: isMobile ? "1.5rem" : width < 1100 ? "2rem" : "4rem",
            borderRadius: isMobile ? "1.5rem" : width < 1100 ? "2rem" : "3rem",
        ...
        row: {
            display: width < 769 ? "flex" : "grid",
            flexDirection: "column",
            gridTemplateColumns: "1fr auto",
            alignItems: width < 769 ? "stretch" : "center",
            padding: width < 769 ? "1.5rem 0" : "2rem 0",
            gap: width < 769 ? "1rem" : "3rem",
        },
        lastRow: {
            borderBottom: "none",
        },
        ...
        footer: {
            ...
            paddingTop: "2rem",
            display: "flex",
            flexDirection: width < 920 ? "column" : "row",
            justifyContent: "space-between",
            alignItems: "center",
            gap: width < 920 ? "1.5rem" : "0",
        },
        saveBtn: {
            background: isSaving
                ? "var(--color-gray-400)"
