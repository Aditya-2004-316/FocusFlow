    ...
    return (
        <div style={styles.modalOverlay} onClick={onClose}>
            ...
            <div style={styles.card} onClick={(e) => e.stopPropagation()}>
                ...
                <div style={Object.assign({}, styles.timer, { textAlign: "center", marginTop: "-1rem", marginBottom: "1rem" })}>
                    {formatTime(timeLeft)}
                </div>
                ...
                <div style={styles.toolbar}>
                            ...
                            {colors.map((c) => (
                                <button
                                    ...
                                    style={{
                                        ...styles.colorButton,
                                        background: c,
                                        ...(color === c && tool === "brush" ? styles.colorButtonActive : {}),
                                    }}
                                    onMouseEnter={(e) => {
                                        e.currentTarget.style.transform = "scale(1.15)";
                                    }}
                                    onMouseLeave={(e) => {
                                        e.currentTarget.style.transform = color === c && tool === "brush" ? "scale(1.1)" : "scale(1)";
                                    }}
                                />
                            ))}
                        </div>
                    ...
                    <div style={styles.toolSection}>
                        <span style={styles.toolLabel}>Size: {brushSize}px</span>
                        <input
                            type="range"
                            min="1"
                            max="20"
                ...
                <div style={styles.actionButtons}>
                    <button
                        ...
                        onMouseEnter={(e) => {
                            e.currentTarget.style.background = "var(--color-red-200)";
                        }}
                        onMouseLeave={(e) => {
