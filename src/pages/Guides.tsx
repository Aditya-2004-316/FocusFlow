...
const Guides = () => {
    ...
    const guideMetaStyle: CSSProperties = {
        display: "flex",
    ...
    const categories = [
        {
            icon: <ClockIcon style={categoryIconStyle} />,
        ...
        {
            icon: <ChartBarIcon style={categoryIconStyle} />,
        ...
        {
            icon: <UserGroupIcon style={categoryIconStyle} />,
        ...
        {
            icon: <Cog6ToothIcon style={categoryIconStyle} />,
    ...
    return (
        <div style={containerStyle}>
            ...
            {categories.map((category, index) => (
                <div key={index} style={categorySectionStyle}>
